package ghostcat.operation.effect
{
    ...
    public class ColorFlashEffect extends RepeatEffect
    {
        ...
        {
            _alpha = v;
            updateTargetColorTransform(ColorUtil.getColorTransform2(color,_alpha));
        }
        ...
        public function clearCurrent():void
        {
            ...
            updateTargetColorTransform(new ColorTransform(color,fromAlpha));
        }
        ...
        {
            for each (var oper:Oper in children)
            {
                oper.halt();
            }
            children.length = 0;
            
            updateTargetColorTransform(new ColorTransform());
            
            super.halt();
        }
        
        protected function updateTargetColorTransform(colorTrans:ColorTransform):void
        {
            (target as DisplayObject).transform.colorTransform = colorTrans;
        }
    }
}