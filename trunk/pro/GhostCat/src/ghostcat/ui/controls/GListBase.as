package ghostcat.ui.controls
{
    ...
    {
        public static var defaultSkin:ClassFactory =  null/*new ClassFactory(ListBackground)*/;
        ...
        public function GListBase(skin:*=null,replace:Boolean = true, type:String = UIConst.VERTICAL,itemRender:* = null)
        {
            ...
            if (skin)
            {
                if (skin is Bitmap)
                {
                    var bitmap:Bitmap = skin as Bitmap;
                    itemSkin = new ClassFactory(Bitmap, null, [bitmap.bitmapData, bitmap.pixelSnapping, bitmap.smoothing]);
                }
            ...
            if (GSprite.inputManager)
                GSprite.inputManager.addEventListener(MouseEvent.DOUBLE_CLICK, onDoubleClickHandler);
        }
        ...
        protected function onDoubleClickHandler(event:MouseEvent):void
        {
            ...
            var o:DisplayObject = event.relatedObject as DisplayObject;
            while (o && o.parent != this)
                o = o.parent;
            
            if (ref && o && ref.isClass(o))
            {
                var e:ItemClickEvent = new ItemClickEvent(ItemClickEvent.ITEM_DOUBLE_CLICK);
                e.data = (o as GBase).data;
                e.relatedObject = o as InteractiveObject;
                dispatchEvent(e);
            }
