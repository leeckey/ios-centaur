...
package net.hires.debug {
	...
	public class Stats extends Sprite {	
		...
		protected var ticks_graph:uint;
		...
		public function Stats() : void {
			...
			xml = <xml><fps>FPS:</fps><ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax><ticks>TICKS:</ticks></xml>;
			...
			style.setStyle('ticks', {color: hex2css(colors.ticks)});
...
//				if( GlobalAPI.tickManager)
//					ticks = GlobalAPI.tickManager.getRendNum();
				...
				ticks_graph = Math.min(graph.height,( ticks / 200 ) * graph.height);
				...
				graph.setPixel(graph.width - 1, graph.height - ticks_graph, colors.ticks);
...
class Colors {
	...
	public var ticks : uint = 0x9A3a1d;
